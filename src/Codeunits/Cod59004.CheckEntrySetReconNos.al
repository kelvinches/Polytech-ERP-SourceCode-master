...
Codeunit 59004 "Check Entry Set Recon.-Nos"
{
    ...
    procedure ToggleReconNo(var CheckLedgEntry: Record "Check Ledger Entry"; var BankAccReconLine: Record 59001; ChangeAmount: Boolean)
    begin
    ...
    procedure SetReconNo(var CheckLedgEntry: Record "Check Ledger Entry"; var BankAccReconLine: Record 59001)
    begin
    ...
    procedure RemoveReconNo(var CheckLedgEntry: Record "Check Ledger Entry"; var BankAccReconLine: Record 59001; Test: Boolean)
    var
