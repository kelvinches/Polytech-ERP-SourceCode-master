...
Table 51516317 "Payroll Employee."
{
    ...
    fields
    {
        field(10; "No."; Code[20])
        {
            ...
            begin
                ...
                if Cust.Find('-') then begin
                    ...
                    Lastname := Cust."Middle Name";
                    Surname := Cust."Last Name";
                    "Employee Email" := Cust."E-Mail";
                    "Bank Account No" := Cust."Bank Account Number";
                    "NHIF No" := Cust."NHIF No.";
                    "NSSF No" := Cust."NSSF No.";
                    "PIN No" := Cust."PIN No.";
        ...
        field(27; "Cummulative Basic Pay"; Decimal)
        {
            ...
            TableRelation = "prPeriod Transactions.";
        }
        ...
        {
            OptionCaption = 'POLYTECH SACCO ';
            OptionMembers = "POLYTECH SACCO ";
        }
