...
Table 59001 "Bank Acc. Reconciliation Lines"
{
    ...
    fields
    {
        ...
        field(2; "Statement No."; Code[20])
        {
            ...
            TableRelation = "Bank Acc. ReconciliationAUT"."Statement No." where("Bank Account No." = field("Bank Account No."));
        }
        ...
        {
            CalcFormula = max("Applied Payment Entry"."Match Confidence" where("Statement Type" = field("Statement Type"), "Bank Account No." = field("Bank Account No."), "Statement No." = field("Statement No."), "Statement Line No." = field("Statement Line No.")));
        ...
        {
            CalcFormula = max("Applied Payment Entry".Quality where("Bank Account No." = field("Bank Account No."), "Statement No." = field("Statement No."), "Statement Line No." = field("Statement Line No."), "Statement Type" = field("Statement Type")));
        ...
        field(50007; "Bank Ledger Entry Line No"; Integer)
        {
        }
        field(50008; "Posting Exch. Entry No."; Integer)
        {
        }
    }
    ...
    var
        ...
        TransactionAmountMustNotBeZeroErr: label 'The Transaction Amount field must have a value different than 0.';
    ...
    var
        AppliedPaymentEntry: Record "Applied Payment Entrys";
    begin
    ...
    procedure FilterBankRecLines(BankAccRecon: Record "Bank Acc. ReconciliationAUT")
    begin
        Reset;
    ...
    procedure LinesExist(BankAccRecon: Record "Bank Acc. ReconciliationAUT"): Boolean
    begin
