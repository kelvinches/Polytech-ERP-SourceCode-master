...
Codeunit 51516010 "Swizzsoft FactoryMobile"
{
    ...
    var
        ...
        ObjProductCharges: Record 51516383;
        ObjMembers: Record 51516364;
        ObjMembers2: Record 51516364;
    ...
    procedure FnGetInterestDueTodate(ObjLoans: Record 51516371): Decimal
    var
    ...
    procedure FnGetInterestDueFiltered(ObjLoans: Record 51516371;DateFilter: Text): Decimal
    var
        ObjLoanRegister: Record 51516371;
    begin
    ...
    procedure FnGetPrincipalDueFiltered(ObjLoans: Record 51516371;DateFilter: Text): Decimal
    var
        ObjLoanRegister: Record 51516371;
    begin
        ObjLoans.SetFilter("Date filter",DateFilter);
    ...
    procedure FnLoanOpeningBalance(ObjLoans: Record 51516371;DFilter: Text) LoanBalance: Decimal
    var
    ...
    procedure FnLoanDisbursement(ObjLoans: Record 51516371;DFilter: Text) LoanBalance: Decimal
    var
        ObjLoansRegister: Record 51516371;
    begin
        ObjLoansRegister.Reset;
    ...
    procedure FnLoanPaidAmount(ObjLoans: Record 51516371;DFilter: Text) LoanBalance: Decimal
    var
        ObjLoansRegister: Record 51516371;
    begin
        ObjLoansRegister.Reset;
    ...
    procedure FnInterestPaid(ObjLoans: Record 51516371;DFilter: Text) LoanBalance: Decimal
    var
        ObjLoansRegister: Record 51516371;
    begin
        ObjLoansRegister.Reset;
    ...
    procedure FnGetInterestVarianceDueTodate(ObjLoans: Record 51516371): Decimal
    var
        ObjLoanRegister: Record 51516371;
    begin
        ObjLoans.SetFilter("Date filter",'..'+Format(Today));
    ...
    procedure FnGetInterestVarianceDueTodateWithFilter(ObjLoans: Record 51516371;DateFilterText: Text[100]): Decimal
    var
        ObjLoanRegister: Record 51516371;
    begin
