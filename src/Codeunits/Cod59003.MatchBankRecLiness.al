...
Codeunit 59003 "Match Bank Rec. Liness"
{
    ...
    procedure MatchManually(var SelectedBankAccReconciliationLine: Record 59001; var SelectedBankAccountLedgerEntry: Record "Bank Account Ledger Entry")
    var
        BankAccReconciliationLine: Record 59001;
    ...
    procedure RemoveMatch(var SelectedBankAccReconciliationLine: Record 59001; var SelectedBankAccountLedgerEntry: Record "Bank Account Ledger Entry")
    var
        BankAccReconciliationLine: Record 59001;
        BankAccountLedgerEntry: Record "Bank Account Ledger Entry";
        BankAccEntrySetReconNo: Codeunit "Bank Acc. Entry Set Recons";
    ...
    local procedure ShowMatchSummary(BankAccReconciliation: Record 59000)
    var
        BankAccReconciliationLine: Record 59001;
        FinalText: Text;
        AdditionalText: Text;
