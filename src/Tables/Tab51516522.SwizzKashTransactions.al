...
Table 51516522 "SwizzKash Transactions"
{
    ...
    fields
    {
        ...
        field(23; "Payroll Number"; Code[20])
        {
            DataClassification = ToBeClassified;
        }
        field(24; "Transaction Code"; Code[100])
        {
            DataClassification = ToBeClassified;
        }
        field(25; "Transfer Verified"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(26; "Transaction Description"; Text[250])
        {
            DataClassification = ToBeClassified;
        }
    }
