...
Page 50042 "Checkoff Processing Header-pos"
{
    // IF Posted=TRUE THEN
                      ...
                      BEGIN
                        REPEAT
                            ...
                            IF NOT ObjLoans.FINDSET THEN
                              BEGIN
                                ObjCheckOffLines."SUPER QUICK":=ObjCheckOffLines."Document No";
                                END;
                    ...
                    IF ObjCheckOffLines.FINDSET THEN
                      BEGIN
                        REPEAT
                            ...
                            IF NOT ObjLoans.FINDSET THEN
                              BEGIN
                                ObjCheckOffLines."SUPER QUICK":=ObjCheckOffLines."Shares Capital";
                                END;
                               UNTIL ObjCheckOffLines.NEXT=0;
                    END;
