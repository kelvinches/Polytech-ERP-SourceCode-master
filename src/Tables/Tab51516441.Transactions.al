...
Table 51516441 Transactions
{
    ...
    fields
    {
            ...
            begin
                ...
                if Account.Get("Account No") then begin
                    ...
                    if Account.Get("Account No") then begin
                        ...
                        // if Account."Bulk Withdrawal App Date For W"="Transaction Date" then
                        //   begin
                        //     //Bulk Transaction***********************
        ...
        field(4; "Transaction Type"; Code[20])
        {
            ...
            else if ("Account No" = filter('')) "Transaction Types" where("Account Type" = filter('MEMBERSHIP'));
        ...
        field(125; "Bankers Cheque No"; Code[20])
        {
            ...
            else if (Type = filter('Cheque Withdrawal')) "Cheque Book Register"."Cheque No." where(Issued = const(false),
                                                                                                                                                                                                         Cancelled = const(false));
            ValidateTableRelation = false;
    ...
    var
        ...
        ObjSignatories: Record "Witness Details";
