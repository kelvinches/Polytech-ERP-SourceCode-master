...
Codeunit 51516996 "S-Mobile"
{
    ...
    begin
        ...
        if Charges.Tiered = true then begin
            Tarrifs.Reset;
            ...
            if Tarrifs.FindFirst then begin
    ...
    begin
        ...
        if SmobileTrans.FindFirst then begin
            repeat
                ...
                Reversed := false;
                //get  charges
                if SmobileTrans."Transaction Type" = SmobileTrans."transaction type"::Reversal then begin
                    Reversals.Reset;
                    ...
                    case SmobileTrans."Transaction Type" of
                        ...
                        SmobileTrans."transaction type"::"Loan Repayment":
                            begin
                                ...
                                if Loantype.FindFirst = false then begin
                                    ...
                                    if Loans.FindFirst = false then begin
                                        ...
                                        if (Loans."Outstanding Balance" > 0) then begin
                                            ...
                                            if Loans."Outstanding Balance" < (SmobileTrans.Amount * -1) then begin
        ...
        if Vendor.Get(Account) then begin
            ...
            if Loans.Find('-') then begin
                repeat
                    Loans.CalcFields(Loans."Outstanding Balance");
                    if (Loans."Outstanding Balance" > 0) then begin
                        if (Loans."Loan Product Type" = Loantype.Code) then begin
                            Qualification := 0;
                            exit;
                        end;
                        if (Loans."Loans Category" <> Loans."loans category"::Perfoming) then
            ...
            if Cust."Current Shares" < 10000 then begin
                Qualification := 0;
                exit;
            end;
            //******Get Salary Deductable Amount
