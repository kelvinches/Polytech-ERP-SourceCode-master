...
Codeunit 51516114 LeaveJnlManagementold
{
    ...
    procedure TemplateSelection(FormID: Integer; var InsuranceJnlLine: Record 51516228; var JnlSelected: Boolean)
    var
        InsuranceJnlTempl: Record 51516187;
    begin
        JnlSelected := true;
    ...
    procedure TemplateSelectionFromBatch(var InsuranceJnlBatch: Record 51516188)
    var
        InsuranceJnlLine: Record 51516228;
        InsuranceJnlTempl: Record 51516187;
        JnlSelected: Boolean;
    begin
        OpenFromBatch := true;
    ...
    procedure OpenJournal(var CurrentJnlBatchName: Code[10]; var InsuranceJnlLine: Record 51516228)
    begin
    ...
    procedure OpenJnlBatch(var InsuranceJnlBatch: Record 51516188)
    var
        InsuranceJnlTemplate: Record 51516187;
        InsuranceJnlLine: Record 51516228;
        JnlSelected: Boolean;
    begin
    ...
    procedure CheckName(CurrentJnlBatchName: Code[10]; var InsuranceJnlLine: Record 51516228)
    var
        InsuranceJnlBatch: Record 51516188;
    begin
        InsuranceJnlBatch.Get(InsuranceJnlLine.GetRangemax("Journal Template Name"), CurrentJnlBatchName);
    end;


    procedure SetName(CurrentJnlBatchName: Code[10]; var InsuranceJnlLine: Record 51516228)
    begin
        InsuranceJnlLine.FilterGroup := 2;
        InsuranceJnlLine.SetRange("Journal Batch Name", CurrentJnlBatchName);
        InsuranceJnlLine.FilterGroup := 0;
    ...
    procedure LookupName(var CurrentJnlBatchName: Code[10]; var InsuranceJnlLine: Record 51516228): Boolean
    var
        InsuranceJnlBatch: Record 51516188;
    begin
        Commit;
    ...
    procedure GetDescriptions(InsuranceJnlLine: Record 51516228; var InsuranceDescription: Text[30]; var FADescription: Text[30])
    var
        Insurance: Record 51516183;
        FA: Record 51516160;
    begin
