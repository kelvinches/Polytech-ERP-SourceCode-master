...
codeunit 51516168 "Match Bank Rec Lines Custom"
{
    ...
    var
        ...
        TEst: record Microsoft.Bank.Reconciliation."Bank Acc. Reconciliation";
    ...
    var
        ...
        GemJournalAccountType: Enum "Gen. Journal Account Type";
    begin
