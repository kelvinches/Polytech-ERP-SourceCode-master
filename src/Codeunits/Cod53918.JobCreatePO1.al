...
Codeunit 53918 "Job Create-PO 1"
{
    ...
    procedure CreateSalesInvoiceLines(JobNo: Code[20]; var JobPlanningLine: Record 53928; InvoiceNo: Code[20]; NewInvoice: Boolean; PostingDate: Date; CreditMemo: Boolean)
    var
    ...
    local procedure CreateSalesheader(Job: Record 53913; PostingDate: Date)
    var
    ...
    local procedure CreateSalesLine(var JobPlanningLine: Record 53928)
    var
        Job: Record 53913;
        Factor: Integer;
    ...
    local procedure TestTransferred(JobPlanningLine: Record 53928)
    var
        SalesLine: Record "Purchase Line";
    ...
    procedure GetSalesInvoice(JobPlanningLine: Record 53928)
    var
        SalesHeader: Record "Purchase Header";
        SalesLine: Record "Purchase Line";
    ...
    local procedure UpdateSalesHeader(var SalesHeader: Record "Purchase Header"; Job: Record 53913)
    begin
    ...
    local procedure TestSalesHeader(var SalesHeader: Record "Purchase Header"; var Job: Record 53913)
    begin
    ...
    procedure TestExchangeRate(var JobPlanningLine: Record 53928; PostingDate: Date)
    var
