...
Codeunit 59002 "Bank Acc. Entry Set Recons"
{
    ...
    procedure ApplyEntries(var BankAccReconLine: Record 59001; var BankAccLedgEntry: Record "Bank Account Ledger Entry"; Relation: Option "One-to-One","One-to-Many"): Boolean
    begin
    ...
    procedure SetReconNo(var BankAccLedgEntry: Record "Bank Account Ledger Entry"; var BankAccReconLine: Record 59001)
    begin
    ...
    procedure RemoveReconNo(var BankAccLedgEntry: Record "Bank Account Ledger Entry"; var BankAccReconLine: Record 59001; Test: Boolean)
    begin
        BankAccLedgEntry.TestField(Open, true);
        if Test then begin
