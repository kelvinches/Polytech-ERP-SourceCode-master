...
Codeunit 55479 "BankAlertMgt FP"
{
    ...
    var
        ...
        TellerSetup: Record 55889;
        BuffAlert: Record 55913;
        Selection: Boolean;
        LineNo: Integer;
    ...
    procedure CreateCashRequest(var Rec: Record 55913; CurrUser: Code[20]): Code[20]
    var
        Request: Record 55914;
        NoSeriesMgt: Codeunit NoSeriesManagement;
        TSetup: Record 55889;
        CSSetup: Record 55903;
    ...
    begin
        ...
        with Rec do begin
            ...
            TSetup.Reset;
            if TSetup.Get(CurrUser) then begin
        ...
        if (UserSelection) and (Req.Count > 0) then begin
            exit(Request."No.");
        end;
    end;
    ...
    begin
        ...
        with Requests do begin
            ...
            if Find('-') then begin
                repeat
                    if "Amount Pending" <> 0 then begin
                        Mark(true);
                        Modify;
                    end
                    else begin
    ...
    procedure CreateCashIssue(var Request: Record 55914)
    var
        Issue: Record 55915;
        NoSeriesMgt: Codeunit NoSeriesManagement;
        CSSetup: Record 55903;
    ...
    procedure CreateCashReceipt(var Issue: Record 55915)
    var
        NoSeriesMgt: Codeunit NoSeriesManagement;
        CSSetup: Record 55903;
        Receipt: Record 55916;
        Selection: Boolean;
    begin
