...
Codeunit 51516016 prPayrollProcessingXX
{
    // ++Note
    ...
    var
        ...
        DaysWorked: Integer;
        prSalaryArrears: Record 51516164;
        prEmployeeTransactions: Record 51516267;
        prTransactionCodes: Record 51516340;
        ...
        prUnusedRelief: Record 51516336;
        ...
        prEmployerDeductions: Record 51516342;
                    ...
                    if prTransactionCodes.Find('-') then begin
                        ...
                        if prTransactionCodes.Subledger <> prTransactionCodes.Subledger::" " then begin
                            if prTransactionCodes.Subledger = prTransactionCodes.Subledger::Customer then begin
                                ...
                                Customer.Reset;
                                Customer.SetRange(Customer."Personal No", HrEmployee."No.");
    ...
    var
        prEmployeeP9Info: Record 51516339;
        intYear: Integer;
        intMonth: Integer;
    begin
    ...
    var
        ...
        startmonth: Integer;
        startYear: Integer;
        "prEmployee P9 Info": Record 51516339;
        P9BasicPay: Decimal;
        P9taxablePay: Decimal;
        P9PAYE: Decimal;
    ...
    var
        ...
        StartDate: Date;
        "prSalary Arrears": Record 51516164;
    begin
