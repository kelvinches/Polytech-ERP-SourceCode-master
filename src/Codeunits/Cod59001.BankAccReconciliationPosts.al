...
Codeunit 59001 "Bank Acc. Reconciliation Posts"
{
    ...
    local procedure InitPost(BankAccRecon: Record 59000)
    begin
    ...
    local procedure Post(BankAccRecon: Record 59000)
    var
        BankAccReconLine: Record 59001;
    ...
    local procedure FinalizePost(BankAccRecon: Record 59000)
    var
        BankAccReconLine: Record 59001;
        AppliedPmtEntry: Record 59004;
    begin
        with BankAccRecon do begin
          // Delete statement
    ...
    local procedure CheckLinesMatchEndingBalance(BankAccRecon: Record 59000;var Difference: Decimal)
    var
        BankAccReconLine: Record 59001;
    begin
    ...
    local procedure CloseBankAccLedgEntry(BankAccReconLine: Record 59001;var AppliedAmount: Decimal)
    begin
    ...
    local procedure CloseCheckLedgEntry(BankAccReconLine: Record 59001;var AppliedAmount: Decimal)
    var
    ...
    local procedure PostPaymentApplications(BankAccReconLine: Record 59001;var AppliedAmount: Decimal)
    var
        AppliedPmtEntry: Record 59004;
    begin
    ...
    local procedure UpdateBank(BankAccRecon: Record 59000;Amt: Decimal)
    begin
    ...
    local procedure TransferToBankStmt(BankAccRecon: Record 59000)
    var
        BankAccStmt: Record 59002;
        BankAccStmtLine: Record 59003;
        BankAccReconLine: Record 59001;
    begin
        if BankAccReconLine.LinesExist(BankAccRecon) then
          repeat
    ...
    local procedure TransferToPostPmtAppln(BankAccRecon: Record 59000)
    var
    ...
    procedure ApplyCustLedgEntry(AppliedPmtEntry: Record 59004;AppliesToID: Code[50];PostingDate: Date;PmtDiscDueDate: Date;PmtDiscToleranceDate: Date;RemPmtDiscPossible: Decimal)
    var
    ...
    procedure ApplyVendLedgEntry(AppliedPmtEntry: Record 59004;AppliesToID: Code[50];PostingDate: Date;PmtDiscDueDate: Date;PmtDiscToleranceDate: Date;RemPmtDiscPossible: Decimal)
    var
    ...
    local procedure IsRefund(BankAccReconLine: Record 59001): Boolean
    begin
