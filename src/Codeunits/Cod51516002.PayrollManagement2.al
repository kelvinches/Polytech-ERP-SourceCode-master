...
Codeunit 51516002 "Payroll Management 2"
{
    ...
    var
        ...
        PayrollPostingGroup: Record 51516324;
        PayrollGenSetup: Record 51516334;
        EmployeeTransactions: Record 51516319;
        EmpTotalAllowances: Decimal;
        "EmpTotalAllowances(LCY)": Decimal;
        PayrollTransactions: Record 51516318;
        ...
        "Salary Arrears": Record 51516325;
    ...
    var
        EmployeeTransactions: Record 51516319;
        TransactionCodes: Record 51516318;
        TransFormula: Text[250];
    begin
        TransAmount := 0;
    ...
    var
        MonthlyTransactions: Record 51516320;
        PayrollEmployee: Record 51516317;
    begin
    ...
    var
        PayrollEmpTrans: Record 51516319;
    begin
    ...
    var
        EmployerDeductions: Record 51516327;
    begin
        if currentAmount = 0 then exit;
    ...
    var
        "Payroll Employer Ded": Record 51516327;
    begin
    ...
    var
        EmployeeTransactions: Record 51516319;
        MonthlyTransactions: Record 51516320;
        EmpPayrollCard: Record 51516317;
    begin
        EmployeeTransactions.Reset;
