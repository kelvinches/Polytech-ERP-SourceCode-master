...
Codeunit 51516107 "Job-JnlManagement"
{
    ...
    var
        ...
        LastJobJnlLine: Record 51516269;
        OpenFromBatch: Boolean;


    procedure TemplateSelection(FormID: Integer; RecurringJnl: Boolean; var JobJnlLine: Record 51516269; var JnlSelected: Boolean)
    var
        JobJnlTemplate: Record 51516274;
    begin
        JnlSelected := true;
    ...
    procedure TemplateSelectionFromBatch(var JobJnlBatch: Record 51516275)
    var
        JobJnlLine: Record 51516269;
        JobJnlTemplate: Record 51516274;
        JnlSelected: Boolean;
    begin
        OpenFromBatch := true;
    ...
    procedure OpenJnl(var CurrentJnlBatchName: Code[10]; var JobJnlLine: Record 51516269)
    begin
    ...
    procedure OpenJnlBatch(var JobJnlBatch: Record 51516275)
    var
        JobJnlTemplate: Record 51516274;
        JobJnlLine: Record 51516269;
        JobJnlBatch2: Record 51516275;
        JnlSelected: Boolean;
    begin
    ...
    procedure GetNames(var JobJnlLine: Record 51516269; var JobDescription: Text[50]; var AccName: Text[50])
    var
        Job: Record 51516271;
        Res: Record Resource;
        Item: Record Item;
