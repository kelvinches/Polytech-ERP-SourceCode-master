...
Table 51516850 "Mwanangu Savings Application"
{
    Caption = 'Product Applications Details';
    DataCaptionFields = "No.", Name;
    DrillDownPageID = 51516430;
    LookupPageID = 51516430;
    ...
    fields
    {
        ...
        field(68133; "Parent Mobile No"; Code[20])
        {
        }
        ...
        field(69196; "Child Name"; Text[50])
        {
