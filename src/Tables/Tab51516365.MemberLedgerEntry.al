...
Table 51516365 "Member Ledger Entry"
{
    Caption = 'Member Ledger Entry';
    DrillDownPageID = 51516369;
    LookupPageID = 51516369;
    ...
    fields
    {
        ...
        field(27; "User ID"; Code[50])
        {
            ...
            trigger OnLookup()
            var
                LoginMgt: Codeunit "Polytech User Management";
            begin
    ...
    trigger OnDelete()
    begin
        Error('You cannot be deleted this');
    end;
...
#pragma warning disable AL0603
    ...
    begin
        ...
        // DummyReportSelections.Usage::MemberLedger,Rec,FIELDNO("Entry No."),DocTxt,FIELDNO("Entry No."),ShowDialog);
    end;
}
