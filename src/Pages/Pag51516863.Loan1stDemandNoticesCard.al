...
Page 51516863 "Loan 1st Demand Notices Card"
{
    PageType = Card;
                ...
                action("1st Notice ")
                {
                    ...
                    begin
                        ...
                        if cust.Find('-') then begin
                            ...
                            SMSMessage."SMS Message" := 'Defaulter First Notice: Dear ,' + "Member Name" + ' you have defaulted  '
                            + "Loan Product Name" + ' with Arrears of KSHs.' + Format(ROUND("Amount In Arrears", 1, '=')) +
