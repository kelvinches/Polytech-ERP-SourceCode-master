...
Table 51516364 "Member Register"
{
    ...
    // DrillDownPageID = 51516366;
    // LookupPageID = 51516366;
    ...
    fields
    {
        ...
        field(50000; "Rejoin status"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(50001; TLoansGuaranteedS; Decimal)
        {
        ...
        field(68023; "Sub-Location"; Text[25])
        {
        }
        field(68024; District; Text[10])
        {
        }
        ...
        field(68028; "Mobile Phone No"; Code[20])
        {
        }
        ...
        field(68100; "Bank Account No."; Code[51])
        {
        }
        field(68101; "Bank Code"; Code[10])
        {
            TableRelation = "Member Group Details"."Account No";
            ValidateTableRelation = false;
        }
        ...
        field(68115; "MPESA Mobile No"; Code[10])
        {
        }
        ...
        field(68192; "Village/Residence"; Text[10])
        {
            TableRelation = "Approvals Set Up".Stage where("Approval Type" = const("File Movement"));
        }
        ...
        field(69059; "Nominee Envelope No."; Code[10])
        {
        }
        ...
        field(69084; "Parish Name"; Text[10])
        {
        }
        ...
        field(69181; "Position Held"; Code[15])
        {
        }
        ...
        field(69233; "Holiday Contribution"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        ...
        field(69237; "Retiring Age"; Date)
        {
            DataClassification = ToBeClassified;
        }
        field(69238; "Insider Lending"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(69239; "Insider Board"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(69240; "Savings Monthly Contribution"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(69241; "Last Boosting Date"; Date)
        {
            DataClassification = ToBeClassified;
        }
        field(69242; "Member Type"; Option)
        {
            DataClassification = ToBeClassified;
            OptionCaption = ',Member,Board,Staff';
            OptionMembers = ,Member,Board,Staff;
        }
        field(69243; "Recruiter Name"; Text[40])
        {
            DataClassification = ToBeClassified;
        }
        field(69244; meeting; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(69245; "Bank Account Name"; Text[15])
        {
            DataClassification = ToBeClassified;
        }
        ...
        field(69248; "Bank Charges on processings"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(69249; "WithholdingTax on gross div"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(69250; "Gross Int On Deposits"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(69251; "Gross Div on share Capital"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(69252; "Member Loan Liability"; Decimal)
        {
