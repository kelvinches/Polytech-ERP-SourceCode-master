...
Table 51516459 "Salary Processing Headerr"
{
    ...
    fields
    {
        ...
        {
            OptionCaption = 'Salary Processing,Nafaka Instant Savings';
            OptionMembers = "Salary Processing","Nafaka Instant Savings";
    ...
    begin
        SUFFIX:='SALARIES';
        if "Transaction Type"="transaction type"::"Nafaka Instant Savings" then
        SUFFIX:='NIS';
