...
Codeunit 51516160 FixedDepositManagement
{
    ...
    var
        ...
        FDInterestCalc: Record 51516448;
        FAccountType: Record 51516436;
        IntRate: Decimal;
        WhichDay: Integer;
        InterestAmount: Decimal;
        FixedDepType: Record 51516447;
        FDDays: Integer;
        IntBufferNo: Integer;
        StatusPermission: Record 51516452;
        EAccount: Code[10];
        EAMount: Decimal;
        i: Integer;
        Tsci: Integer;
    ...
    var
        ShortMessage: Record 51516471;
        Account: Record 51516435;
    begin
    ...
    procedure CalculateFDInterest(Account: Record 51516435;RunDate: Date)
    begin
