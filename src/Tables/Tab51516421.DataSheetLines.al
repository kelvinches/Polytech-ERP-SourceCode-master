...
Table 51516421 "Data Sheet Lines"
{
    ...
    fields
    {
        ...
        field(41;"Kanisa Savings";Decimal)
        {
            DataClassification = ToBeClassified;
        }
        ...
        field(44;"Loan Type";Text[50])
        {
            DataClassification = ToBeClassified;
        }
        field(45;"Loan No";Code[30])
        {
            DataClassification = ToBeClassified;
        }
        field(46;Repayment;Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(47;"Checkoff Period";Date)
        {
            DataClassification = ToBeClassified;
        }
    }
    ...
    keys
    {
        key(Key1;"Payroll No","Data Sheet Line","Member No","Checkoff Period")
        {
            Clustered = true;
        }
    }
