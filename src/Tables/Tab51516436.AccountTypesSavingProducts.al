...
Table 51516436 "Account Types-Saving Products"
{
    ...
    fields
    {
        ...
        field(951; "Over Draft Issue Charge %"; Decimal)
        {
        }
        field(971; "Allow Multiple Over Draft"; Boolean)
        {
        }
        field(921; "Allow Over Draft"; Boolean)
        {
        }
        field(931; "Over Draft Interest %"; Decimal)
        {
        }
        field(941; "Over Draft Interest Account"; Code[20])
        {
            TableRelation = "G/L Account";
        }
        field(961; "Over Draft Issue Charge A/C"; Code[20])
        {
            TableRelation = "G/L Account";
        }
