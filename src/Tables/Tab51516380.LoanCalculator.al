...
{
    DrillDownPageID = "Receipt Header Card";
    LookupPageID = "Receipt Header Card";
        ...
        field(10;"Requested Amount";Decimal)
        {
            ...
            begin
                ...
                LoanType.Reset;
                 LoanType.SetRange(LoanType.Code,"Loan Product Type");
                if LoanType.Find('-') then begin
                "Qualification As Per Deposit":=("Current Deposits"*LoanType."Shares Multiplier")-("Total Loans Outstanding"-"Total Loans To Offset");
