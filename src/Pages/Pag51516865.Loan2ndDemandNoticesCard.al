...
Page 51516865 "Loan 2nd  Demand Notices Card"
{
    DeleteAllowed = false;
    InsertAllowed = false;
    PageType = Card;
                        ...
                        if LoanGuar.Find('-') then begin
                            ...
                            repeat
                                ...
                                if cust.Find('-') then begin
                                    ...
                                    SMSMessage.Insert;
                                    //If loan amount in arreas is not paid within one month,we will recover from your deposit
