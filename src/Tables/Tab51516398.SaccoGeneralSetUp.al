...
Table 51516398 "Sacco General Set-Up"
{
    ...
    fields
    {
        ...
        field(95; "ATM Card Fee-Account"; Code[10])
        {
            TableRelation = "G/L Account";
        }
        ...
        field(1015; "Overdraft App Nos."; Code[20])
        {
        ...
        field(108; "Dividend Process Fee Account"; Code[10])
        {
            TableRelation = "G/L Account";
        }
        ...
        field(172; "Variance Risk Gl"; Code[14])
        {
            TableRelation = "G/L Account";
        }
        ...
        field(175; "Default Micro Credit Posting G"; Code[10])
        {
            TableRelation = "Customer Posting Group".Code;
        }
        ...
        field(181; "Share Capital Transfer Fee Acc"; Code[10])
        {
            TableRelation = "G/L Account"."No.";
        }
        ...
        field(189; "Partial Deposit Refund Fee A/C"; Code[10])
        {
            TableRelation = "G/L Account"."No.";
        }
        ...
        field(193; "Standing Order Bank"; Code[10])
        {
        }
        field(194; "Penalty Monthly Contribution"; Decimal)
        {
        }
        field(195; "Penalty Monthly Contr. Account"; Code[10])
        {
            TableRelation = "G/L Account"."No.";
        }
        ...
        field(198; "Share Capital Grace Period"; Integer)
        {
            DataClassification = ToBeClassified;
        }
        field(199; "Loan Top Up Commision"; Code[10])
        {
            DataClassification = ToBeClassified;
            TableRelation = "G/L Account";
        }
        field(200; "EFT Fee Account"; Code[10])
        {
            DataClassification = ToBeClassified;
        }
        field(201; "EFT Fee"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(202; "Loan Top Up Commision(%)"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(203; "Loan Top Up Commision(Min)"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(204; "Loan Cutoff Date"; Code[10])
        {
            DataClassification = ToBeClassified;
        }
        field(205; "Share Capital Period"; Code[10])
        {
            DataClassification = ToBeClassified;
        }
        field(206; "Loan Top Up Commision2(%)"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(207; "Consolidation Commission(%)"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(208; "Max Boosting Amount"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(209; "Memb.Withdrawl Maturity Period"; Integer)
        {
            DataClassification = ToBeClassified;
        }
        field(210; "Last Loan Reminder Date"; Date)
        {
            DataClassification = ToBeClassified;
        }
        field(211; "Send Defaulter SMS"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(212; "Send Remainder SMS"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(213; "Ledger Fee"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(214; "Partial Disbursement Account"; Code[10])
        {
            DataClassification = ToBeClassified;
            TableRelation = "G/L Account";
        }
        field(215; "Ledger Fee Account"; Code[10])
        {
            DataClassification = ToBeClassified;
            TableRelation = "G/L Account";
        }
        field(216; "Four Months  Interest Account"; Code[10])
        {
            DataClassification = ToBeClassified;
            TableRelation = "G/L Account";
        }
        field(217; "Four Month Multiplier"; Integer)
        {
            DataClassification = ToBeClassified;
        }
        field(218; "Commission on Offset"; Code[10])
        {
            DataClassification = ToBeClassified;
            TableRelation = "G/L Account";
        }
        field(220; "Rjoining Fee Account"; Code[10])
        {
            DataClassification = ToBeClassified;
            TableRelation = "G/L Account"."No.";
        }
        field(221; "HolidaySavings(%)"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
    }
