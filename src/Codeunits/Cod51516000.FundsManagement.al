...
Codeunit 51516000 "Funds Management"
{
    ...
    procedure PostPayment("Payment Header": Record 51516000; "Journal Template": Code[20]; "Journal Batch": Code[20])
    var
    ...
    procedure PostBoardPayment("Payment Header": Record 51516000; "Journal Template": Code[20]; "Journal Batch": Code[20])
    var
        GenJnlLine: Record "Gen. Journal Line";
        LineNo: Integer;
        PaymentLine: Record "Payment Line";
    ...
    procedure PostReceipt("Receipt Header": Record 51516002; "Journal Template": Code[20]; "Journal Batch": Code[20])
    var
        GenJnlLine: Record "Gen. Journal Line";
        LineNo: Integer;
        ...
        SourceCode: Code[20];
        BankLedgers: Record "Bank Account Ledger Entry";
        ReceiptLine2: Record 51516003;
        ReceiptHeader2: Record 51516002;
    begin
        ...
        GenJnlLine.Description := ReceiptHeader."Received From" + ' ' + ReceiptLine.Description;
    ...
    procedure ReverseReceipt("Receipt Header": Record 51516002; "Journal Template": Code[20]; "Journal Batch": Code[20])
    var
        GenJnlLine: Record "Gen. Journal Line";
        LineNo: Integer;
        ReceiptLine: Record 51516003;
    ...
    procedure PostMemberReceipt("Receipt Header": Record 51516002; "Journal Template": Code[20]; "Journal Batch": Code[20])
    var
        GenJnlLine: Record "Gen. Journal Line";
        LineNo: Integer;
        ReceiptLine: Record 51516003;
    ...
    procedure ReverseMemberReceipt("Receipt Header": Record 51516002; "Journal Template": Code[20]; "Journal Batch": Code[20])
    var
        GenJnlLine: Record "Gen. Journal Line";
        LineNo: Integer;
        ReceiptLine: Record 51516003;
    ...
    procedure PostFundsTransfer("Funds Transfer Header": Record 51516056; "Journal Template": Code[20]; "Journal Batch": Code[20])
    var
        GenJnlLine: Record "Gen. Journal Line";
        LineNo: Integer;
        FundsLine: Record 51516005;
        FundsHeader: Record 51516056;
        SourceCode: Code[20];
        BankLedgers: Record "Bank Account Ledger Entry";
        FundsLine2: Record 51516005;
        FundsHeader2: Record 51516056;
    begin
