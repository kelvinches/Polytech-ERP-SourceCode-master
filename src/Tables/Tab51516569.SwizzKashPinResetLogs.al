...
Table 51516569 "SwizzKash Pin Reset Logs"
{
    LookupPageID = 51516582;
    ...
    fields
    {
        field(1; "Entry No"; Integer)
        {
            ...
            begin
                ...
                //   SaccoNoSeries.GET;
                //   NoSeriesMgt.TestManual(SaccoNoSeries."SwizzKash Registration Nos");
                //   SentToServer := '';
                // END;
            end;
        }
    ...
    begin
        ...
        //   SaccoNoSeries.GET;
        //   SaccoNoSeries.TESTFIELD(SaccoNoSeries."SwizzKash Registration Nos");
        //   NoSeriesMgt.InitSeries(SaccoNoSeries."SwizzKash Registration Nos",xRec.SentToServer,0D,"Entry No",SentToServer);
        // END;
    end;
