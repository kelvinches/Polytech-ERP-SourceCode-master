...
Codeunit 51516119 AdminPortal
{
    ...
    var
        PortalAdmin: Record 51516489;
        ProductsSetup: Record 51516381;
        ...
        RiskAllocation: Record 51516015;
        FILEFOLDER: label '\\ERP\Reports\';
        filename: Text;
        LoanApprovalCommitee: Record 51516429;
    ...
    begin
        ...
        if OnlineUser.Find('-') then begin
            ...
            else if (OnlineUser."Changed Password" = true) and (OnlineUser.Password <> HOPassword) then begin
                ReturnBoolean := false;
                ReturnList := 'ERROR, Old password do not match';
            end;
            ...
            if (objMember.Status = objMember.Status::Active) or
              ...
              (objMember.Status = objMember.Status::Defaulter) then begin
                ...
                if (objMember."Phone No." <> '') or (objMember."Mobile Phone No" <> '') or (objMember."E-Mail" <> '') then begin
                    ...
                    end else if objMember."Mobile Phone No" <> '' then begin
                        ReturnBoolean := true;
                        SMSMessage('PORTALTRAN', FAccNo, objMember."Phone No.", ReturnList);
                    end;
              ...
              then begin
                ...
                if OnlineUser.Find('-') then begin
                    if (OnlineUser.Password = Password) and (OnlineUser."Changed Password" = false) then
                        Login := true
                    else if (OnlineUser.Password = HPassword) and (OnlineUser."Changed Password" = true) then
                        Login := true;
                end;
            end;
        end;
    ...
    begin
        Approvals.Reset;
        // Approvals.SETFILTER("Approver ID", 'EMMANUEL/Swizzsoft23');
