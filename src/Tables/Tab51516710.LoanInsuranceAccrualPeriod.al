...
Table 51516710 "Loan Insurance Accrual Period"
{

    fields
    {
        field(1;"Insurance Due Date";Date)
        {
            ...
            trigger OnValidate()
            begin
                Name := Format("Insurance Due Date",0,Text000);
            end;
        }
        ...
        field(50003;"Insurance Calcuation Date";Date)
        {
    ...
    var
        AccountingPeriod2: Record "Loan Insurance Accrual Period";
