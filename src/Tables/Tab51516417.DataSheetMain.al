...
Table 51516417 "Data Sheet Main"
{
    ...
    fields
    {
        ...
        field(69024;"Member No";Code[20])
        {
            DataClassification = ToBeClassified;
        }
        field(69025;Amount;Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(69026;"Loan Type";Code[20])
        {
            DataClassification = ToBeClassified;
        }
    }
    ...
    keys
    {
        key(Key1;"PF/Staff No","Type of Deduction","Remark/LoanNO")
        {
            Clustered = true;
