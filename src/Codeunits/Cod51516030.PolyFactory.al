...
Codeunit 51516030 "Poly Factory"
{
    ...
    var
        ObjLoanProductType: Record 51516381;
    begin
    ...
    var
        ObjSaccoGeneralSetup: Record 51516398;
    begin
    ...
    var
        ObjGuaranteeDetails: Record 51516372;
    begin
    ...
    var
        ObjMemberRegister: Record 51516364;
        ObjGuaranteeDetails: Record 51516372;
    ...
    var
        ObjLoanGuaranteeDetails: Record 51516372;
    begin
    ...
    var
        ObjLoanTopUpDetails: Record 51516376;
    begin
    ...
    var
        ObjLoanCollateral: Record 51516374;
    begin
    ...
    var
        ObjLoanguarantor: Record 51516372;
    begin
    ...
    var
        ObjLoanRepaymentSchedule: Record 51516375;
        PrevMonth: Date;
        DateParm: Date;
        RepaymentDate: Date;
    begin
    ...
    var
        ObjLoanProductSetUp: Record 51516381;
    begin
    ...
    var
        ObjMembersRegister: Record 51516364;
    begin
    ...
    var
        objformreception: Record 51516562;
        Date: Date;
    begin
    ...
    var
        ObjLoanProductCharges: Record 51516383;
        Amount: Decimal;
        ObjLoansReg: Record 51516371;
    begin
    ...
    var
        ObjFileRequest: Record 51516296;
    begin
    ...
    var
        SaccoGeneralSetUp: Record 51516398;
    begin
    ...
    var
        ...
        LoanOffsetDetails: Record 51516376;
    begin
        /*LoansRegister.RESET;
    ...
    var
        LoansRegisterLocal: Record 51516371;
    begin
    ...
    var
        DemandSavingsInterestBuffer: Record 51516915;
    begin
    ...
    var
        MemberLedgEntry: Record 51516365;
    begin
    ...
    procedure FnPostRetinedDeposits(MemberR: Record 51516364; DocNo: Code[20]; LoanNo: Code[20]; FreedAmt: Decimal; Dim1: Text[50]; Dim2: Text[50])
    var
        LineN: Integer;
        GenJournalLine: Record "Gen. Journal Line";
    begin
