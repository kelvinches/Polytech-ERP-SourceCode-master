...
Table 59000 "Bank Acc. ReconciliationAUT"
{
    ...
    var
        ...
        ProcessBankAccRecLines: Codeunit 59005;
    begin
    ...
    begin
        if BankAccReconciliation.HasFilter then begin
            ...
            BankRecHeader.SetFilter("Balance Last Statement", BankAccReconciliation.GetFilter("Balance Last Statement"));
        end;
        ...
        repeat
            ...
            BankAccReconciliation."Balance Last Statement" := BankRecHeader."Balance Last Statement";
            BankAccReconciliation."Statement Ending Balance" := BankRecHeader."Statement Ending Balance";
            BankAccReconciliation.Insert;
