...
Page 51516078 "FOSA Role Center"
{
    Caption = 'Role Center';
    PageType = RoleCenter;
        ...
        area(sections)
        {
            ...
            group("FOSA Setups")
            {
                ...
                action("Supervisor Approvals Levels")
                {
                    ...
                    RunObject = Page "CheckOff Period";
                }
                action("ATM Charges")
                {
                    ApplicationArea = Basic;
                    Caption = 'ATM Charges';
                    RunObject = Page 51516330;
                }
                ...
                action("Account Details-editable")
                {
                    ...
                    RunObject = Page "Member Witness Card";
                }
