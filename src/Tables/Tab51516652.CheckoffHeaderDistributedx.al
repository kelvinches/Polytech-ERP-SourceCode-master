...
Table 51516652 "Checkoff Header-Distributedx"
{
    ...
    fields
    {
        ...
        field(21; "Posting date"; Date)
        {
            ...
            trigger OnValidate()
            begin
                PeriodYear := Date2dmy("Posting date", 3);
                Remarks := 'Checkoff' + ' ' + FnGetCheckOffDescription();
                "Document No" := FnGetCheckOffDescription() + ' ' + Format(PeriodYear);
            end;
        }
